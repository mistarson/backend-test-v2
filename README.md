## 필수 요구 사항
- [x] 새로운 결제 제휴사 연동 (TestPg API 연동)
- [x] 결제 내역 조회 API 구현
- [x] 제휴사별 수수료 정책 적용
## 선택 과제
- [x] 추가 제휴사 연동(Adapter 추가 및 전략 선택)
- [x] 오픈API 문서화(springdoc 등) 또는 간단한 운영지표(로그/메트릭)
- [x] MariaDB 등 외부 DB로 전환(docker-compose 포함) 및 마이그레이션 도구 적용
